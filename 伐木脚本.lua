...
local library = nil
local urls = {
    "https://github.com/CloudX-ScriptsWane/baijiaobengv4beta/raw/main/silent%20ui.txt",
    "https://raw.githubusercontent.com/wally-rblx/linoria/main/source.lua",
}
for _, url in ipairs(urls) do
    local success, result = pcall(function() return loadstring(game:HttpGet(url, true))() end)
...
if not library then
    game:GetService("StarterGui"):SetCore("SendNotification", {Title="错误", Text="UI库加载失败，请检查网络", Duration=5})
    return
end
local window = library:new("小星--伐木大亨2", '')
...
Section:Button("获取当前死亡后加载时间", function()
    bailib:Notification("小星", " 时间为" .. bai.loaddupeaxewaittime .. "秒", "好")
end)
...
Sectionbringtree:Dropdown("选择树", 'Dropdown',
    {"普通树", '幻影木', "沼泽黄金", "樱花", "蓝木", "冰木", "火山木", "橡木", "巧克力木",
     "小星桦木", "黄金木", "雪地松", "僵尸木", "大巧克力树", "椰子树", '南瓜木', '幽灵木'},
    function(b)
        if b == '普通树' then
...
local drop = Sectionzhenglimt:Dropdown("选择木头类型", 'Dropdown',
    {"普通树", "沼泽黄金", "樱花", "蓝木", "冰木", "火山木", "橡木", "巧克力木", "小星桦木",
...
Sectionhuanjin:Toggle("终日小星天", 'Toggleflag', false, function(state)
    if state then
        bai.awaysday = true
        while task.wait() do
...
local l = {'按钮', '控制杆', '电线', '4/4x1木楔', '3/4x1木楔', '2/4x1木楔', '1/4X1木楔', '3/3x1木楔',
           ...
           '橙色发光线', '绿色发光线', '黄色发光线', '小星色发光线', '紫色发光线',
